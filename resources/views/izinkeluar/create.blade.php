<form action="{{ route('izinkeluar.store') }}" id="formcreateIzinKeluar" method="POST">
    @csrf
    ...
    <div class="row">
        <div class="col-lg-6 col-md-12 col-sm-12">
            <x-input-with-icon label="Jam Keluar" name="jam_keluar" icon="ti ti-clock" type="time" />
        </div>
        <div class="col-lg-6 col-md-12 col-sm-12">
            <x-input-with-icon label="Jam Kembali (Opsional)" name="jam_kembali" icon="ti ti-clock" type="time" />
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <x-textarea label="Keperluan" name="keperluan" />
        </div>
    </div>
    <div class="row mt-2">
        <div class="col-12">
...
<script>
    $(function() {
        ...
        $("#formcreateIzinKeluar").submit(function() {
