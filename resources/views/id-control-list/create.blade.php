@extends('layouts.app')
@section('title', 'Tambah ID Control List')

@section('content')
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah ID Control List</h1>
    ...
    <div class="id-control-card shadow mb-4">
        <div class="id-control-header">
            <h6 class="m-0 font-weight-bold">Form Tambah ID Control List</h6>
        </div>
        <div class="id-control-body">
            <form action="{{ route('id-control-list.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Period <span class="text-danger">*</span></label>
                            <input type="date" name="period" class="form-control" required value="{{ date('Y-m-d') }}">
                        </div>
                        <div class="form-group">
                            ...
                            <select name="nama_aplikasi" class="form-select select2Aplikasi" required>
                                ...
                                @foreach($aplikasis as $app)
                                    <option value="{{ $app->nama_aplikasi }}">{{ $app->kode_aplikasi }} - {{ $app->nama_aplikasi }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Role / ID Name <span class="text-danger">*</span></label>
                            <input type="text" name="role" class="form-control" required placeholder="Contoh: Customer Service Officer">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Divisi</label>
                            <input type="text" name="division" id="division" class="form-control" placeholder="Terisi otomatis..." readonly>
                        </div>
                        <div class="form-group">
                            <label>Type ID</label>
