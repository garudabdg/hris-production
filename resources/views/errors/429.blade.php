    ...
    <div class="w-full max-w-lg relative z-10">
        <div class="glass-effect rounded-3xl p-10 shadow-2xl text-center" data-aos="zoom-in" data-aos-duration="1000">
            ...
            <p class="text-gray-500 mb-8 px-4" data-aos="fade-up" data-aos-delay="600">
                Maaf, Anda telah melakukan terlalu banyak permintaan ke sistem kami dalam waktu singkat. Demi keamanan, sistem membatasi akses sementara. Silakan tunggu beberapa menit dan coba lagi.
            </p>
