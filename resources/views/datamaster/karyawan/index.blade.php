                            ...
                            <div class="col-12">
                                @foreach ($karyawan as $d)
                                    <div class="card mb-2 shadow-sm border" style="transition: all 0.2s ease;">
                                        <div class="card-body p-2" style="cursor: pointer;" onclick="if(!event.target.closest('a') && !event.target.closest('button') && !event.target.closest('form')) { window.location.href='{{ route('karyawan.show', Crypt::encrypt($d->nik)) }}'; }" onmouseover="this.parentElement.style.transform='translateY(-2px)'; this.parentElement.style.boxShadow='0 .5rem 1rem rgba(0,0,0,.15)'" onmouseout="this.parentElement.style.transform='none'; this.parentElement.style.boxShadow='0 .125rem .25rem rgba(0,0,0,.075)'">
