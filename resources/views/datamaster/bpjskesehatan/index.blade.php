    ...
    <div class="d-flex justify-content-between align-items-center w-100">
        <div>
            ...
            <div class="text-muted mt-1" style="font-size: 0.75rem; font-weight: normal; text-transform: none; letter-spacing: 0px;">
                Manajemen data iuran BPJS Kesehatan karyawan.
            </div>
        </div>
        <nav aria-label="breadcrumb" class="d-none d-md-block" style="font-size: 0.75rem;">
            <ol class="breadcrumb breadcrumb-style1 mb-0">
                ...
                <li class="breadcrumb-item active">
                    <i class="ti ti-heart-handshake ti-xs me-1"></i> BPJS Kesehatan
                </li>
            </ol>
        </nav>
    </div>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center py-2" style="background-color: var(--theme-color-1) !important; color: white !important; min-height: 50px;">
                <div class="d-flex align-items-center">
                    ...
                    <h6 class="card-title mb-0 text-white">Data BPJS Kesehatan</h6>
                </div>
            </div>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            @foreach ($bpjskesehatan as $d)
                                <tr>
                                    <td class="py-2">{{ $d->kode_bpjs_kesehatan }}</td>
                                        ...
                                        <div class="d-inline-flex border rounded overflow-hidden shadow-xs">
                                            @can('bpjskesehatan.edit')
                                                <a href="#" class="btn btn-sm btnEdit px-2 py-1 border-0 rounded-0"
                                                    kode_bpjs_kesehatan="{{ Crypt::encrypt($d->kode_bpjs_kesehatan) }}" title="Edit"
