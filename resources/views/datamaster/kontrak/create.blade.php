    ...
    <div class="row">
        ...
        <div class="form-group mb-1">
            <select name="jenis_kontrak" id="jenis_kontrak" class="form-select">
                ...
                <option value="M" @selected(old('jenis_kontrak') == 'M')>Mitra</option>
                <option value="O" @selected(old('jenis_kontrak') == 'O')>Outsourcing</option>
                <option value="P" @selected(old('jenis_kontrak') == 'P')>Probition</option>
                <option value="G" @selected(old('jenis_kontrak') == 'G')>Magang</option>
            </select>
            @error('jenis_kontrak')
