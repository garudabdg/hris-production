...
<head>
    <meta charset="utf-8">
    <title>Form Checklist Perawatan Aset</title>
    <style>
        @page {
            margin: 20px;
        }
...
<body>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td width="55%" class="text-center fw-bold" style="font-size: 14px;">
                CHEKLIST PERAWATAN {{ strtoupper($asset->category ? $asset->category->nama_kategori : 'ASET') }}
            </td>
    ...
    <table class="info-table" style="margin-top: 10px; margin-bottom: 10px;">
        <tr>
            <td width="15%" class="fw-bold">Kode Aset</td>
            <td width="2%">:</td>
            <td width="33%">{{ $asset->kode_asset }}</td>
            
            <td width="15%" class="fw-bold">Tanggal Perawatan</td>
            <td width="2%">:</td>
            <td width="33%">___________________________</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>:</td>
            <td>{{ $asset->cabang ? $asset->cabang->nama_cabang : 'Pusat' }}</td>
