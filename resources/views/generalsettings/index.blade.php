                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-select" name="provider_wa" id="provider_wa">
                                <option value="local" @selected(($setting->provider_wa ?? 'local') == 'local')>Lokal / Sendiri (Direkomendasikan)</option>
                                <option value="ig" @selected(($setting->provider_wa ?? 'local') == 'ig')>Internal Gateway (Portax/Asfimedia)</option>
                                <option value="fe" @selected(($setting->provider_wa ?? 'local') == 'fe')>Fonnte</option>
                            </select>
                            <small class="text-muted">
                                <strong>Lokal / Sendiri:</strong> Gunakan WA Gateway mandiri di server ini (port 3000).
                                Domain otomatis: <code>http://127.0.0.1:3000</code>
                            </small>
                        </div>
                        ...
                        <x-input-with-icon-label label="Domain WA Gateway (contoh: https://wa.didimax.online)" name="domain_wa_gateway"
