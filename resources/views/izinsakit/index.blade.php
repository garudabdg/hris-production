                                                ...
                                                @if (!empty($d->doc_sid))
                                                    <div class="mt-1 d-block d-md-none">
                                                        @if (Storage::disk('public')->exists('uploads/sid/' . $d->doc_sid))
                                                            <a href="{{ Storage::url('uploads/sid/'.$d->doc_sid) }}" target="_blank" class="text-primary" style="font-size: 11px;">
                                            ...
                                            <div class="col-md-3 border-start border-end d-none d-md-block text-center">
                                                 ...
                                                 <div class="text-muted" style="font-size: 11px;">
                                                    ...
                                                    @if (!empty($d->doc_sid))
                                                        ...
                                                        @if (Storage::disk('public')->exists('uploads/sid/' . $d->doc_sid))
                                                            <a href="{{ Storage::url('uploads/sid/'.$d->doc_sid) }}" target="_blank" class="text-primary" title="Lihat SID">
                                                                <i class="ti ti-file-text me-1"></i>SID
                                                            </a>
                                                        @else
