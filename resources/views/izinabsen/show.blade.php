        ...
        <div class="alert alert-danger d-flex align-items-start gap-3 rounded-3 mt-3 p-3">
            ...
            <div class="flex-grow-1">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <form method="POST" action="{{ route('izinabsen.cancelapprove', $encryptedKode) }}" id="formResetCutiVisible" class="d-inline">
                        @csrf
                        @method('DELETE')
...
$(function() {
    ...
    $('#btnEditFromShow').on('click', function() {
        ...
        $('#loadmodal').load('/izinabsen/' + encryptedKode + '/edit');
    });
});
</script>
@endif
